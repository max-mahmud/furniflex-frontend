...
import vertor_Bottom from "../assets/Vector.png"
import vertor_Top from "../assets/Vector@2x.png"
...
const Header = () => {
  ...
  return (
    <div className="border-b-[1px_solid_#F1F1F1] bg-[#FFFFFF] m-[0_0_80px_0] flex flex-row justify-between p-[39px_120px_38px_120px] w-[1440px] box-sizing-border">
      ...
      <div className="flex flex-row box-sizing-border">
        <Link to="/orderdetails" className="relative m-[5.7px_24px_3px_0] flex flex-col items-center p-[0_0_0_5.3px] box-sizing-border">
          <img src={vertor_Bottom} alt="img" className="absolute left-[0px] top-[7.3px] w-[25.3px] h-[19.3px]" />
          <img src={vertor_Top} alt="img" className="relative m-[0_9.7px_8px_0] w-[14.7px] h-[7.3px]" />
